    ...
    import com.lmt.Kanban.exception.*;
    ...
    public class AuthServiceImpl implements AuthService {
        ...
        public void register(RegisterRequest request) {
            if (userRepository.existsByUsername(request.getUsername())) {
                throw new ConflictException(ErrorCode.USERNAME_ALREADY_EXISTS,"Username already used");
            }
            if (userRepository.existsByEmail(request.getEmail())) {
                throw new ConflictException(ErrorCode.EMAIL_ALREADY_EXISTS,"Email already used");
            }
        ...
        public JwtResponse refreshAccessToken(String refreshTokenValue) {
            ...
            if (refreshTokenService.isTokenExpired(refreshToken)) {
                ...
                throw new TokenRevokedException("Refresh token was expired. Please make a new signin request");
            }
